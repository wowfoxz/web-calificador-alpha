...
const HomePage = () => {
  ...
  useEffect(() => {
    fetch('/data/empleados.json')
      ...
      .then(data => {
        const empleadosConCalculos = data.empleados.map((empleado: Empleado) => calcularCalificacionYSalario(empleado));
  ...
  return (
    ...
    <div>
      ...
      <EmpleadoTable empleados={empleados} setEmpleados={setEmpleados} />
    </div>
    <div>
    <h1>My App</h1>
